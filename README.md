...
<div align="center">
<img src="https://skillicons.dev/icons?i=aws,python,postgresql,git,github,vscode,docker,linux&theme=dark" />
</div>
...
|:---|:---|
| **Cloud & Data Engineering** | AWS Glue, AWS S3, AWS Athena, AWS Lambda |
| **Linguagens** | Python, SQL |
| **Análise & BI** | Power BI, Pandas, Jupyter Notebook |
| **Versionamento** | Git, GitHub |
| **Ambiente** | VS Code, Linux |
...
```bash
cindy@data-terminal:~$ cat objetivos_2026.txt

[■■■■■■■■■■■■■■■■□□□□] 80%  Dominar AWS Glue e pipelines serverless
[■■■■■■■■■■■■□□□□□□□□] 60%  Aprofundar Engenharia de Dados na nuvem
